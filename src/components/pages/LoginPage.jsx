  ...
  return (
    <div className="text-center pt-5">
      ...
      <div className="flex items-center justify-center pt-3">
        <button class="flex items-center bg-white dark:bg-gray-900 border border-gray-300 rounded-lg shadow-md px-6 py-2 text-sm font-medium text-gray-800 dark:text-white hover:bg-red-400 ">
